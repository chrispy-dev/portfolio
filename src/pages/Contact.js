...
export const Contact = ({ formValues, setFormValues, onInputChange, onFormSubmit, fun, colorChanger, emailSent, setEmailSent }) => {
    return (
        <div className="flex flex-col justify-center items-center min-h-nav-screen-fun">
            <h2 className="text-center pb-8 text-2xl px-4">Get in contact with me!<br /> Let's {colorChanger('create')} something.</h2>
            <div className="flex flex-col justify-center items-center md:flex-row md:pb-10 w-full">
