...
export const About = () => {
    return (
        <div className="flex flex-col justify-center items-center min-h-nav-screen max-w-screen-md">
            ...
            <img className="py-8" src={process.env.PUBLIC_URL + "./imgs/chris.png"} />
            <div className="px-8 py-8">
                ...
                <h1 className="text-4xl font-pacifico text-center py-8">Game Analytics</h1><br />
                <p className="text-lg">Websites like <a target="_blank" href="https://mobalytics.gg/" className="underline">Mobalytics.gg</a>, <a target="_blank" href="https://u.gg/" className="underline">U.gg</a>, or <a target="_blank" href="https://www.wowhead.com/" className="underline">Wowhead.com</a> changed the way I saw the internet forever. I realized that there is beauty in data, and by association, how you display that data amongst other information.</p><br />
